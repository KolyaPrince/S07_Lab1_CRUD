    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId = 3, Name = "Pan", Description = "A regular pan", Force = 5, Image = "https://publicdomainvectors.org/photos/Shield-ClassicMedieval1.png", Price = 25, Qty = 10, QtyBought = 1, CreatedDate = new DateTime(1999, 01, 1) }
                );
            #endregion
        }
    }
